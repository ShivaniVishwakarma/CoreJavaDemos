...
public class ABDemo {
	public static void main(String[] args) {
		...
		//a1.m5(); //Compile time errors when we call child class methods from parent class object:
		//a1.m6(); //Compile time errors when we call child class methods from parent class object:
}
}
